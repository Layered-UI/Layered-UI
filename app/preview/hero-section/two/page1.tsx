...
export default function HeroSection() {
  return (
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-28 overflow-hidden">
      {/* Background */}
      <motion.div
        className="absolute inset-x-3 sm:inset-x-4 md:inset-x-6 lg:inset-x-8 top-2 sm:top-4 bottom-24 sm:bottom-32 md:bottom-40 lg:bottom-56 rounded-2xl sm:rounded-3xl"
        style={{
          backgroundImage: "url('/assets/19401.png')",
