...
import { TrendingUpIcon, SquareMousePointerIcon, BlocksIcon } from "lucide-react";
        ...
        <div className="grid h-full sm:grid-cols-2">
            <div className="relative z-10 space-y-6 py-8 ps-8 pe-2">
                ...
                <div className="space-y-2">
                    ...
                    <FeatureDescription>
                        Manage &amp; scale your business effortlessly using our
...
function IntegrationTile({ row, col, logo }: TileData) {
    return (
        <div
            className={cn(
                "absolute flex size-14 items-center justify-center rounded-xl border border-border transition-all duration-300 sm:size-16",
                logo
        ...
        >
            {logo && (
                <img
                    alt={logo.alt}
                    className={cn(
                        "pointer-events-none size-7 select-none object-contain p-1 sm:size-8",
    ...
    return (
        <div className="grid max-h-120 sm:grid-cols-2">
            <div className="space-y-6 pt-8 pb-4 pl-8 sm:pb-8">
                <div className="flex size-12 items-center justify-center rounded-full border bg-card shadow-xs outline outline-border/80 outline-offset-2">
                    <BlocksIcon className="size-5 text-primary/80" />
                </div>
                <div className="space-y-2">
                    <FeatureTitle className="text-base">
            ...
            <div className="relative flex min-h-[320px] items-center justify-center overflow-hidden">
                <div
                    className="relative size-[320px] scale-90 sm:scale-100"
                    style={{
                        maskImage:
