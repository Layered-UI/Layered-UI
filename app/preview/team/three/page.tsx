...
const members = [
    ...
    },
    {
        name: 'Elijah Jones',
        role: 'Co-Founder - CTO',
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ElijahJones',
        link: '#',
    },
    {
        name: 'Isabella Garcia',
        role: 'Sales Manager',
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=IsabellaGarcia',
        link: '#',
    },
    {
        name: 'Henry Lee',
        role: 'UX Engineer',
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=HenryLee',
        link: '#',
    },
    {
        name: 'Ava Williams',
        role: 'Interaction Designer',
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=AvaWilliams',
        link: '#',
    },
    {
        name: 'Olivia Miller',
        role: 'Visual Designer',
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=OliviaMiller',
        link: '#',
    },
]
