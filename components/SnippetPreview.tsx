    ...
    return (
        <Dialog>
            ...
            <DialogContent className="!max-w-3xl max-h-[85vh] flex flex-col">
                ...
                <div className="relative grid w-full overflow-auto flex-1">
                    <Button 
                        onClick={copy} 
                        size="icon" 
                        variant="ghost" 
                        className="absolute right-0.5 top-0.5 z-10 size-8 rounded-md text-white/75 hover:bg-white/10 hover:text-white" 
                    ...
                    <CodeBlock 
                        code={displayedCode} 
                        lang="tsx" 
                        className="[&_pre]:min-h-auto [&_pre]:rounded-(--radius) [&_pre]:max-w-none! !w-full [&_pre]:border-none dark:[&_pre]:!bg-zinc-900 [&_pre]:pr-12" 
                    />
                </div>
            </DialogContent>
        </Dialog>
